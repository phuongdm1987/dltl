...
{{ FormCreator::openForm() }}
   ...
   <?php
      echo FormCreator::makeControl("Name", FormCreator::text(array("name" => "name", "value" => Input::old('name') , "class" => "form-control")));
		echo FormCreator::makeControl("Age", FormCreator::text(array("name" => "age", "value" => Input::old('age') , "class" => "form-control")));
