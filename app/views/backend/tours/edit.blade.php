...
@section('styles')
	...
	<style type="text/css" media="screen">
		...
		**/
		...
		.main-body .tagsinput span.tag {
			margin-top: 4px;
			margin-left: 2px;
		}
		.main-body .tagsinput span.tag a {
			margin-top: 0;
		}
		.main-body .tagsinput #tags_tag {
			margin-top: 0px;
		}
		.main-body #places_addTag #places_tag {
			width: 150px;
			margin-top: 0px;
		}
		.main-body .note {
...
<div class="page-header">
	<h3>
		Sửa tour {{ $tour->tou_name }}
	</h3>
</div>
<div class="main-body">

<ul class="nav nav-tabs">
	<li class="active"><a href="#tab-info" data-toggle="tab">Thông tin tour </a></li>
	<li><a href="#tab-content" data-toggle="tab">Thông tin mở rộng</a></li>
</ul>
<p class="clearfix"></p>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-info">
			...
			<div class="form-group {{ $errors->has('tou_name') ? 'has-error' : '' }}">
				<label for="tou_name" class="col-sm-2 control-label">Tên tour <b class="text-danger">*</b></label>
				<div class="col-sm-9">
			...
			@if($tour->tou_id > 0)
				<div class="form-group">
					<label for="tou_image" class="col-sm-2 control-label"></label>
					<div class="col-sm-2">
			...
			<div class="form-group {{ $errors->has('tou_image') ? 'has-error' : '' }}">
				<label for="tou_image" class="col-sm-2 control-label">Ảnh đại diện</label>
				<div class="col-sm-8">
			...
			<div class="form-group {{ $errors->has('tou_price') ? 'has-error' : '' }}">
				<label for="tou_price" class="col-sm-2 control-label">Giá <b class="text-danger">*</b></label>
				<div class="col-sm-6">
			...
			<div class="form-group {{ $errors->has('tou_day') ? 'has-error' : '' }}  {{ $errors->has('tou_night') ? 'has-error' : '' }}">
				<label for="tou_day" class="col-sm-2 control-label"> Thời gian <b class="text-danger">*</b></label>
			...
			{{--Khởi hành--}}
			<div class="form-group">
				<label for="tou_end_time" class="col-sm-2 control-label">Khởi hành</label>
				<div class="col-sm-6">
			...
			<div class="form-inline form-group week hide">
				<label for="week" class="col-sm-2 control-label">Ngày trong tuần</label>
				<div class="col-sm-9">
			...
			<div class="month hide">
				<div class="form-group">
					<label for="tou_day_month" class="col-sm-2 control-label">Lịch cố định</label>
					<div class="col-sm-6">
			...
			<div class="form-group {{ $errors->has('tou_type') ? 'has-error' : '' }}">
				<label for="tou_type" class="col-sm-2 control-label">Phân loại khu vực <b class="text-danger">*</b></label>
				<div class="col-sm-6">
					{{ Form::select('tou_type',  [ 0 => 'Chọn loại', 1 => 'Trong nước', 2 => 'Nước ngoài'], $tour->tou_type, ['class' => 'form-control']) }}
			...
			<div class="form-group {{ $errors->has('tou_departure') ? 'has-error' : '' }}">
				<label for="tou_departure" class="col-sm-2 control-label">Điểm khởi hành <b class="text-danger">*</b></label>

				{{--Quốc gia--}}
				<div class="col-sm-2">
					<select name="tou_country_departure" class="form-control select2">
				...
				{{--Thành phố--}}
				<div class="col-sm-2">
					<select name="tou_city_departure" class="form-control select2" id="tou_city_departure">
			...
			<div class="form-group {{ $errors->has('tou_country_destination') ? 'has-error' : '' }}">
				<label for="tou_country_destination" class="col-sm-2 control-label">Quốc gia <b class="text-danger">*</b></label>
				{{--Quốc gia--}}
				<div class="col-sm-6">
					<select name="tou_country_destination" class="form-control select2">
						@foreach($countries as $country)
			...
			<div class="form-group {{ $errors->has('tou_place_destination') ? 'has-error' : '' }}">
				<label for="tou_place_destination" class="col-sm-2 control-label">Địa danh đến</label>
				{{--Quốc gia--}}
				<div class="col-sm-9">
			...
			<div class="form-group {{ $errors->has('tou_tags') ? 'has-error' : '' }}">
				<label for="tou_tags" class="col-sm-2 control-label">Tags</label>
				{{--Quốc gia--}}
				<div class="col-sm-9">
			...
			<div class="form-group {{ $errors->has('tou_vehicle') ? 'has-error' : '' }}">
				<label for="tou_vehicle" class="col-sm-2 control-label">Phương tiện <b class="text-danger">*</b></label>
				<div class="col-sm-6">
		...
		<div class="tab-pane" id="tab-content">
				...
				<div class="col-sm-9">
					@if(isset($photos))
						@foreach($photos as $photo)
							<a data-fancybox-group="button" class="tour-photo fancybox" href="{{ PATH_IMAGE_TOUR . $photo->tim_tour_image }}"  style="background: url('{{ PATH_IMAGE_TOUR . $photo->tim_tour_image }}') center center; background-size: cover; height: 50px; width: 50px; display: inline-block;"></a>
						@endforeach
					@endif
				</div>
			</div>
			...
			<div class="form-group {{ $errors->has('tim_tour_image') ? 'has-error' : '' }}">
				<label for="tim_tour_image" class="col-sm-2 control-label">Ảnh tour <br/>(Chọn nhiều)</label>
				<div class="col-sm-2">
			...
			<div class="form-group {{ $errors->has('tco_tour_schedule') ? 'has-error' : '' }}">
				<label for="tco_tour_schedule" class="col-sm-2 control-label">Lịch trình</label>
				<div class="col-sm-9">
			...
			<div class="form-group {{ $errors->has('tco_tour_comprise') ? 'has-error' : '' }}">
				<label for="tco_tour_comprise" class="col-sm-2 control-label">Giá bao gồm</label>
				<div class="col-sm-9">
			...
			<div class="form-group {{ $errors->has('tco_tour_policies') ? 'has-error' : '' }}">
				<label for="tco_tour_policies" class="col-sm-2 control-label">Chính sách</label>
				<div class="col-sm-9">
