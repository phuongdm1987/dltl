	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="form-group {{ $errors->has('activated') ? 'has-error' : '' }}">
				<label class="control-label col-sm-2" for="activated">Kích hoạt tài khoản</label>
				<div class="col-sm-6">
				...
				<div class="form-group col-sm-3">
					...
					<div class="radio inline">
						<label for="{{ $permission['name'] }}_allow" onclick="">
							<input type="radio" value="1" id="{{ $permission['name'] }}_allow" name="permissions[{{ $permission['name'] }}]">
							Cho phép
						</label>
					</div>
					...
					<div class="radio inline">
						<label for="{{ $permission['name'] }}_deny" onclick="">
							<input type="radio" value="-1" id="{{ $permission['name'] }}_deny" name="permissions[{{ $permission['name'] }}]">
							Cấm
						</label>
					</div>
