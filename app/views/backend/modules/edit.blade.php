...
<form class="form-horizontal" method="post" action="" autocomplete="off" role="form">
   ...
   <div class="tab-content">
      ...
      <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
         ...
         <div class="col-sm-6">
            <input type="text" class="form-control" name="name" id="name" value="{{ Input::old('name', $module->name) }}" placeholder="VD: Quản lý bài viết..." />
      ...
      <div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">
         ...
         <div class="col-sm-6">
            <input type="text" class="form-control" name="link" id="link" value="{{ Input::old('link', $module->link) }}" placeholder="VD: /admin/posts" />
      ...
      <div class="form-group {{ $errors->has('order') ? 'has-error' : '' }}">
         ...
         <div class="col-sm-6">
            <input type="text" class="form-control" name="order" id="order" value="{{ Input::old('order', $module->order) }}" />
            {{ $errors->first('order', '<span class="help-inline text-danger">:message</span>') }}
         </div>
      </div>

      <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
         <label class="control-label col-sm-2" for="icon">Bootstrap icon</label>
         <div class="col-sm-6">
            <input type="text" class="form-control" name="icon" id="icon" value="{{ Input::old('icon', $module->icon) }}" placeholder="VD: glyphicon glyphicon-home,..." />
