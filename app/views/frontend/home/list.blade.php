...
@section('content')
   <div id="maincontent" class="container-fluid">
      <div id="wrapper_content">
         {{-- Box right --}}
         <div class="box_content_right col-md-9 col-sm-9">
                     ...
                     <li>
                        <div class="tour_result_item">
                           <table style="width: 100%;">
                              <tr>
                                 <td class="tour_result_item_left col-md-9 col-sm-6 col-xs-6">
                                    ...
                                    <div class="box_item_bottom">
                                       <div class="box_item_bottom_left col-md-6">
                                       ...
                                       <div class="box_item_bottom_right col-md-6">
                                          <div class="tour_attr">
                                             <a href="http://mytour.vn/tour/34-city-tour-da-lat-1-ngay.html">
                                 ...
                                 <td class="tour_result_item_right col-md-3 col-sm-6 col-xs-6">
         ...
         {{-- Box left --}}
         <div class="box_content_left col-md-3 col-sm-3">
                  ...
                  <form id="tour_search" style="position: relative;" name="tour_search" action="" method="GET" onsubmit=""> 
                     ...
                     <div class="form_item">
                        <select>
                           ...
                           <option>Hồ Chí Minh (Sài Gòn)</option>
                           <option>Hà Nội</option>
                        </select>
                     </div>
                     <div class="form_item">
                        <p>Khoảng thời gian khởi hành:</p>
                        <input type="text" name="timefrom" value="20/05/2015" class="select_date check_time_from datepicker">
                        <input type="text" name="timeto" value="19/07/2015" class="select_date check_time_to datepicker">
                     </div>
                     <div class="form_item">
                           ...
                           <li style="padding-left: 10px;">
                              <form action="" method="GET" name="price_filter" enctype="">
                                 <select>
                                    ...
                                    <option>0-2000k</option>
                                    <option>2000k-4000k</option>
                                 </select>
                              </form>
                           </li>
                        </ul>
