	...
	<div id="content" class="page-main">
		<div class="container">
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 hidden-sm hidden-xs sidebar-offcanvas" id="sidebar" role="navigation">
					<div class="sidebar-nav-fixed affix">
						<div class="panel panel-default sidebar-menu with-icons">
							<div class="panel-heading">
								<h3 class="panel-title">Danh sách tính năng</h3>
							</div>
				...
				<div class="col-md-9 clearfix">
					<!-- Tính năng nổi bật -->
					<section class="waa-docs-section">
						<h2 id="hot"><i class="fa fa-star-o"></i> Tính năng nổi bật</h2>
						<div class="waa-box-content">
							<section class="waa-photo">
								<img src="{{ asset('assets/img/waa/hot.jpg') }}" alt="Tính năng nổi bật" class="img-responsive">
							</section>
							<!-- Thống kê-->
					...
					<!-- Quản lý thống kê-->
					<section class="waa-docs-section">
						<h2 id="statistic"><i class="fa fa-pie-chart"></i> Quản lý thống kê</h2>
						<div class="waa-box-content">
							<div class="row">
								<div class="col-md-6">
									<div class="waa-photo">
										<img src="{{ asset('assets/img/waa/doanhthuloinhuan.jpg') }}" alt="" class="img-responsive">
									</div>
								...
								<div class="col-md-6">
									<div class="waa-photo">
										<img src="{{ asset('assets/img/waa/doanhthunhanvien.jpg') }}" alt="" class="img-responsive">
									</div>
									<div class="text-center">
					...
					<!-- Quản lý bán hàng-->
					<section class="waa-docs-section">
						<h2 id="orders"><i class="fa fa-cart-plus"></i> Quản lý bán hàng</h2>
						<div class="waa-box-content">
							<section class="waa-photo">
					...
					<!-- Quản lý sản phẩm -->
					<section class="waa-docs-section">
						<h2 id="products"><i class="fa fa-cubes"></i> Quản lý sản phẩm</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/sanpham.jpg') }}" alt="Sản phẩm" class="img-responsive">
									</div>
					...
					<!-- Quản lý kho-->
					<section class="waa-docs-section">
						<h2 id="stores"><i class="fa fa-database"></i> Quản lý kho</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/nhaphang.jpg') }}" alt="Nhập hàng" class="img-responsive">
									</div>
								...
								<div class="row list-item">
									...
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/chuyenhang.jpg') }}" alt="Chuyển hàng" class="img-responsive">
									</div>
								</div>
							</section>
						</div>
					...
					<!-- Quản lý nhân viên-->
					<section class="waa-docs-section">
						<h2 id="staffs"><i class="fa fa-users"></i> Quản lý nhân viên</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/phanquyen.jpg') }}" alt="Nhập hàng" class="img-responsive">
									</div>
								...
								<div class="row list-item">
									...
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/thaydoithongtin.jpg') }}" alt="Thay đổi thông tin" class="img-responsive">
									</div>
								</div>
							</section>
						</div>
					...
					<!-- Quản lý chi nhánh-->
					<section class="waa-docs-section">
						<h2 id="branch"><i class="fa fa-code-fork"></i> Quản lý chi nhánh, nhà cung cấp</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/chinhanh.jpg') }}" alt="Quản lý chi nhanh" class="img-responsive">
									</div>
								...
								<div class="row list-item">
									...
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/supplier.jpg') }}" alt="Quản lý chi nhanh" class="img-responsive">
									</div>
								</div>
							</section>
						</div>
					...
					<!-- Quản lý báo cáo-->
					<section class="waa-docs-section">
						<h2 id="report"><i class="fa fa-krw"></i> Quản lý báo cáo</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/report.jpg') }}" alt="Quản lý báo cáo" class="img-responsive">
									</div>
					...
					<section class="waa-docs-section">
						<h2 id="debts"><i class="fa fa-money"></i> Quản lý công nợ, sổ quỹ</h2>
						<div class="waa-box-content">
							<section class="no-mb padding-big text-center-sm">
								<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/soquy.jpg') }}" alt="Quản lý công nợ" class="img-responsive">
									</div>
								...
								<div class="row list-item">
									...
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/thuchicongno.jpg') }}" alt="Quản lý công nợ" class="img-responsive">
									</div>
								</div>
							</section>
						</div>
					...
					<!-- Quản lý lịch sủ-->
					<section class="waa-docs-section">
						<h2 id="history"><i class="fa fa-history"></i> Quản lý lịch sử</h2>
						<div class="waa-box-content">
							<div class="row list-item">
									<div class="col-md-7">
										<img src="{{ asset('assets/img/waa/history.jpg') }}" alt="Quản lý lịch sử" class="img-responsive">
									</div>
...
@section("scripts")
	{{-- <script type="text/javascript" src="{{ asset('assets/js/frontends/stickySidebar.js') }}"></script> --}}
	<script>
		$(function() {
