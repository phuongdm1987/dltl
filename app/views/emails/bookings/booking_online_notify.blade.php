...
@section('content')
	<tr>
		<td style="font-weight:bold; font-size:18px; padding:20px 0px; background-color: #fff;" align="center">{{ $booking->getBookingCode() }} - {{ SITE_NAME }} xác nhận đặt tour</td>
	</tr>
	<tr>
		<td style="background-color: #fff; padding: 0 25px;">
			<p style="margin:0px 0px 10px 0px">Chào <strong> {{ $booking->getCustomerName() }},</strong></p>
			<p style="margin:0px 0px 10px 0px">Cám ơn quí khách đã đặt tour du lịch : <b>{{ $tour->tou_name }}</b></p>
			<p style="margin:0px 0px 10px 0px">
				Chúng tôi xác nhận với quí khách về vị trí của quí khách theo lịch trình và ngày quí khách đã đặt.
			</p>
			<p style="margin:0px;">
				Quý khách vui lòng thanh toán bằng tiền mặt tại văn phòng của
				<b> {{ $user->fullName() }} : {{ $user->address }}</b>.
			</p>
			<p style="margin:0px;font-style:italic">
				Chân thành cám ơn quí khách!
			</p>
		</td>
	</tr>
	<tr>
