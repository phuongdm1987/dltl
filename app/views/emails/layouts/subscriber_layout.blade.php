					  ...
					  <tbody>
							...
							<tr>
								 <td style="padding: 15px;">
									  <a href="{{ url() }}?utm_source=email_register_subs&utm_medium=cpc&utm_campaign=email_marketing" style="display:block">
											<img src="{{ url() }}/assets/img/medium_fsd_logo.png" alt="fsd14.com" width="114px" height="40px">
									  </a>
								 </td>
							</tr>
							<!-- Banner Top -->
							  ...
							  <td>
									<table border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#fff" width="620" style="font-family:arial; font-size:12px; line-height:1.4em;">
										 <tbody>
											  <tr>
													<td>
														 <a href="{{ url() }}?utm_source=email_register_subs&utm_medium=cpc&utm_campaign=email_marketing" title="Cộng đồng lập trình viên Việt Nam">
															  <img src="{{ url() }}/assets/img/waa/hot.jpg" alt="Phần mềm quản lý bán hàng" width="620" style="display:block; width:100%;">
														 </a>
													</td>
											  </tr>
										 </tbody>
										...
										<tbody>
											...
											<tr>
												 <td style="padding:8px 0px; vertical-align:top; text-align:center;">
													  Cập nhật những bài viết mới nhất, tin tức của Waa tại:
												 </td>
											</tr>
											{{-- <tr>
											...
											<tr>
												 <td style="padding:8px 0px; vertical-align:top; text-align:center;">
													  <strong>Waa developer © {{ $data['time'] }}</strong>
												 </td>
											</tr>
											<!-- <tr>
												 <td style="padding:0px; vertical-align:top; text-align:center;">
													  <a style="color:#00aeef; text-decoration:none;" href="#">Quyền</a>
													  <span style="color:#e3e3e3;">|</span>
													  <a style="color:#00aeef; text-decoration:none;" href="#">Quy định</a>
												 </td>
											</tr> -->
										</tbody>
									</table>
								...
								<td>
									 <table border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#e4e4e4" width="620" style="font-family:arial; font-size:11px; line-height:1.4em; padding:5px">
										  <tbody>
												<tr>
													 <td style="padding:0px; vertical-align:top; text-align:center;">
														  Nếu bạn không muốn nhận email, xin vui lòng <a style="color:#00aeef; text-decoration:none;" href="{{ url() }}/unsubscribe?email={{ $data['email'] }}&utm_source=email_register_unsubs&utm_medium=cpc&utm_campaign=email_marketing">click vào đây.</a>
													 </td>
												</tr>
										  </tbody>
									 </table>
